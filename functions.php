...
function computeChecksum(array $boxes)
{
    ...
    foreach($boxes as $box )
    {
        ...
        $twoAdded = false; // determine si une lettre avec 2 occurrences a été déjà comptabilisée
        $threeAdded = false;// determine si une lettre avec 3 occurrences a été déjà comptabilisée
